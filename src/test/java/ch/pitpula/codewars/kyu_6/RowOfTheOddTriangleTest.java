...
import ch.pitbula.codewars.kyu_6.RowOfTheOddTriangle;

import static org.junit.jupiter.api.Assertions.assertArrayEquals;


class RowOfTheOddTriangleTest {
    @Test
    public void test_1() {
        assertArrayEquals(new long[]{1}, RowOfTheOddTriangle.oddRow(1));
    }

    @Test
    public void test_2() {
        assertArrayEquals(new long[]{3, 5}, RowOfTheOddTriangle.oddRow(2));
    }
